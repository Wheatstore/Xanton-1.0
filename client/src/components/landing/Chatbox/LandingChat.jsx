...
const ui = {
  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen bg-black overflow-hidden flex items-center justify-center px-4 py-8">
        {/* Background / Orb */}
              ...
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 flex-shrink-0 mx-auto sm:mx-0">
                ...
                >
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-purple-900/45 to-blue-900/45 flex items-center justify-center">
                    <img src="https://firebasestorage.googleapis.com/v0/b/xanton-1.firebasestorage.app/o/Nikola%20Tesla.webp?alt=media&token=c007069a-c674-4fcf-80f0-b4ddd6af180d" alt="Nikola Tesla" className="w-full h-full object-cover"/>
                  </div>
                ...
                return (
                  ...
                  >
                    {!isUser && (
                      ...
                      >
                        <span className="text-[10px] select-none"><img src="https://firebasestorage.googleapis.com/v0/b/xanton-1.firebasestorage.app/o/Nikola%20Tesla.webp?alt=media&token=c007069a-c674-4fcf-80f0-b4ddd6af180d" alt="Nikola Tesla" className="rounded-full" /></span>
                      </div>
                    )}
